...
public class MarcaView {
    ...
    private MarcaController marcaCtrl;
    private Scanner scanner;

    public MarcaView(MarcaController marcaCtrl) {
            ...
            try {
                ...
                switch (opcao) {
                    ...
                    case 5:
                        ...
                        break;
                    case 0:
                        System.out.println("Encerrando módulo de marcas de peças...");
                        break;
                    default:
    ...
    private void cadastrarMarca() {
        System.out.println("\n--- Cadastrar Marca de Peça ---");
        System.out.print("Digite o Nome da Marca (ex: Bosch): ");
    ...
    private void buscarPorId() {
        ...
        Marca marca = marcaCtrl.findById(id);
    ...
    private void buscarPorNome() {
        ...
        Marca marca = marcaCtrl.findByName(nome);
        System.out.println(marca.toString());
    }
}